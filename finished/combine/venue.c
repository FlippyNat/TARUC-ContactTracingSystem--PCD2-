...
void addVenue() {
	...
	int count = 1, catChoice = 0, dayChoiceStart = 0, dayChoiceEnd = 0, validResult = 0, validDate = 0, validDay = 0,exist=0;
	...
	do {
		...
		do {
			do {
				printf("\n\t\t\t\t\t\tChoose T0%.2d venue category:", count);
				scanf("%s", &intCheck);
				rewind(stdin);
		...
		do {
			printf("\n\t\t\t\t\t\tEnter T0%.2d venue maximum visitors allowed:", count);
			scanf("%s", &intCheck);
			rewind(stdin);
		...
		do {
			...
			do {
				printf("\n\t\t\t\t\t\tChoose T0%.2d venue operating day start:", count);
				scanf("%s", &intCheck);
				rewind(stdin);
		...
		do {
			do {
				printf("\n\t\t\t\t\t\tChoose T0%.2d venue operating day end:", count);
				scanf("%s", &intCheck);
				rewind(stdin);
		...
		do {
			do {
				printf("\n\t\t\t\t\t\tEnter T%.3d venue operation start time in 24 hour format(hhmm):", count);
				scanf("%s", &intCheck);
				rewind(stdin);
			...
			do {
				printf("\n\t\t\t\t\t\tEnter T%.3d venue operation end time in 24 hour format(hhmm):", count);
				scanf("%s", &intCheck);
				rewind(stdin);
